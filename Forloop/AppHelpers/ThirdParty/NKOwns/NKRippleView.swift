...
//  RideApp
//
//  Created by Nakul Sharma on 09/07/18.
 ...
 */
final class NKRippleView: UIView {
    ...
    private func getLayer() -> NKRippleCALayer {
        ...
        let circleShape = NKRippleCALayer()
...
extension NKRippleView: NKAnimationDelegate {
    func animationDidStop(_ anim: CAAnimation, layer: CALayer, finished: Bool) {
        layer.removeFromSuperlayer()
//        print_debug("removed layer")
//        print_debug(layer)
    }
}

extension NKRippleCALayer: CAAnimationDelegate {
    public func animationDidStop(_ anim: CAAnimation, finished flag: Bool) {
        self.animationDelegate?.animationDidStop(anim, layer: self, finished: flag)
    }
}

final class NKRippleCALayer: CAShapeLayer {
    var animationDelegate: NKAnimationDelegate?
}

protocol NKAnimationDelegate {
    func animationDidStop(_ anim: CAAnimation, layer: CALayer, finished: Bool)
}
