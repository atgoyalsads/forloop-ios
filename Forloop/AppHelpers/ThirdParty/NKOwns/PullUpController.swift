...
open class PullUpController: UIViewController {
    ...
    open var pullUpControllerPreviewOffset: CGFloat {
       // let extraHeightOfStatusBar = UIApplication.shared.statusBarFrame.height - 20

        let navH: CGFloat = UIApplication.shared.statusBarFrame.height+44
        let minusH = 80+navH//+extraHeightOfStatusBar
    ...
    open var pullUpControllerPreferredSize: CGSize {
        ...
        let minusH = 80+navH//+extraHeightOfStatusBar
        let totalH = UIScreen.main.bounds.height - minusH
        return CGSize(width: UIScreen.main.bounds.width, height: totalH)
    }
