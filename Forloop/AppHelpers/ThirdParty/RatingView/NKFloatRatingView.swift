//
//  NKFloatRatingView.swift
//  EatWeDo
//
//  Created by TecOrb on 13/02/17.
//  Copyright © 2017 Nakul Sharma. All rights reserved.
//

import UIKit

@objc public protocol NKFloatRatingViewDelegate {
    /**
     ...
     */
    @objc optional func floatRatingView(_ ratingView: NKFloatRatingView, isUpdating rating: Float)
}
 ...
 */
@IBDesignable
open class NKFloatRatingView: UIView {

    // MARK: Float Rating View properties

    open weak var delegate: NKFloatRatingViewDelegate?
    ...
    override open func touchesEnded(_
