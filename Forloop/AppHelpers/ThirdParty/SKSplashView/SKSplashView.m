...
- (instancetype)initWithAnimationType:(SKSplashAnimationType)animationType frame:(CGRect)frame
{
...
- (instancetype) initWithSplashIcon:(SKSplashIcon *)icon animationType:(SKSplashAnimationType)animationType frame:(CGRect)frame
{
    self = [self initWithAnimationType:animationType frame:frame];
    if(self) {
        _splashIcon = icon;
